...
function checkCookies() {
  ...
  var cookieNotification = document.getElementById('cookie');
  var cookieBtn = cookieNotification.querySelector('.cookie__button'); // Если записи про кукисы нет или она просрочена на 1 год, то показываем информацию про кукисы
...
var graphicsElementsCircle = document.querySelectorAll('.solution__canvas');
